...
# ✅ Patch for PyTorch >= 2.6 to allow YOLOv8 SegmentationModel to load
...
def main():
    st.set_page_config(page_title="YOLOv8 Segmentation App", layout="centered")
        ...
        if "video" in file_type:
            ...
            if st.button("🧠 Process Image"):
                with st.spinner("Segmenting image..."):
                    ...
                    st.download_button("⬇️ Download", data=buffer.tobytes(), file_name="segmented_image.png", mime="image/png")
        else:
